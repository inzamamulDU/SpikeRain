...
parser.add_argument('--data_path', type=str, default="/home/name/datasets/img_restoration/deraining/rain1400/test/input")
parser.add_argument('--save_path', type=str, default="/home/name/projects/img_restoration/sota/spikerain/output/dense_attn_FRB22")
...
parser.add_argument('--weights', type=str, default="/home/name/projects/img_restoration/SpikeRain/checkpoints/SpikeRain_M/models/dense_attn_bs12_lr_1e_3/model_best.pth")
...
def OLD_load_checkpoint(model, weights):
